...
double ISP::calculateEar(const dlib::full_object_detection& shape, const int leftEye[], const int rightEye[]) { // EAR�� ����ϴ� �Լ�
    // ���� ���� ��ǥ ����
...
double ISP::eyeAspectRatio(const dlib::full_object_detection& landmarks, int p1, int p2, int p3, int p4, int p5, int p6) { // EAR�� ����ϴ� �Լ�
...
void ISP::initializeCamera(int i, VideoCapture& cap) //ī�޶� �ʱ⼼��
{ 
    cap.open(i);
    if (!cap.isOpened()) {
        cerr << "Error: ī�޶� �� �� �����ϴ�." << endl;
...
void ISP::initializeDlib(dlib::frontal_face_detector& detector, dlib::shape_predictor& landmark_predictor) //dlib - face_detector, face_landmarks ����
{ 
    detector = dlib::get_frontal_face_detector();
    dlib::deserialize("shape_predictor_68_face_landmarks.dat") >> landmark_predictor;
}

void ISP::calculateFPS(Mat& frame, int& frameCount, chrono::time_point<chrono::high_resolution_clock>& start_fps) //�ʴ� ������ �� ���
{ 
...
void ISP::detectEyesAndSleep(Mat& frame, dlib::frontal_face_detector detector, dlib::shape_predictor landmark_predictor, bool& sleep,clock_t& start, clock_t& end) //EAR�� ���� �� ���� ���� �Ǵ�
{
    ...
    if (faces.empty()) {
        ...
        for (const auto& face : faces) {
            ...
            if (sleep == true) {
                putText(frame, "Sleep", Point(10, 60), FONT_HERSHEY_SIMPLEX, 1, Scalar(0, 255, 255), 2); // ���� ��
                //http sleep=1
            }
            else {
                putText(frame, "Good", Point(10, 60), FONT_HERSHEY_SIMPLEX, 1, Scalar(0, 0, 255), 2); // ������� ��
                //http sleep=0
            }
        }
    }
...
int ISP::videotoframe(Mat& frame, VideoCapture& cap) // ���� -> �̹���
{
    cap >> frame;
    if (frame.empty()) {
        cerr << "���� ��Ʈ���� ����Ǿ����ϴ�." << endl;
